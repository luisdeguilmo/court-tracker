...
export function FolderMenuDropdown({ folder, selectedFolder }) {
    return (
        <>
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <button
                        className={`-mr-2 p-2 rounded-full outline-none border-none focus:ring-0 hover:bg-gray-200 ${selectedFolder && selectedFolder?.id === folder?.id && "bg-gray-100"}`}
                    >
