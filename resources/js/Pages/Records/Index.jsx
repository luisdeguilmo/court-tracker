    ...
    return (
        <div className="">
            ...
            <div className="relative min-h-screen">
                ...
                <div className="flex">
                    <div
                        className={`w-full mx-auto py-6 space-y-8 overflow-y-scroll h-125 ${selectedFolder && "pr-4"}`}
                    >
                        {/* Subfolders grid */}
                        {displayFolders.length > 0 && (
                            <section>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                                    {files.map((file) => (
                                        <FileCard
                                            ...
                                            file={file}
                                            accessToken={
                                                "7E2n5IGgPp7IB3QAAI3cNMh7IcnmpL3F"
                                            }
                                        />
                                    ))}
                                </div>
...
function FolderCard({ folder, onClick, onDoubleClick }) {
    return (
        <Card
            onDoubleClick={onDoubleClick}
            onClick={onClick}
            className="cursor-pointer hover:bg-gray-100 hover:shadow-md transition"
        >
            <CardContent>
